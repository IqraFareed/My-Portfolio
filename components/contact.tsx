...
const Contact = () => {
  ...
  return (
    <motion.section
      id="contact"
      ref={ref}
      className="relative mb-24 sm:mb-32 w-[min(100%,40rem)] text-center scroll-mt-[10rem]"
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-black-600/10 via-pink-600/10 to-bla-600/10 blur-3xl rounded-3xl" />
